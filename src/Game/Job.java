...
//	private static Logic M(int n, int L) {return new Mult(n, L);}
	...
	public final static Labor MakeBow = Labor.newCraft("Craft Crossbow",			I(timber),					I(bow),			P_.CARPENTRY,						null,		-1);
	...
	public final static Labor ForgeGun = Labor.newCraft("Smith Arquebus",			AND(I(iron), M(2, timber)),	I(gun),			P_.SMITHING,						null,		-1);
	...
	public final static Labor MakeJewel = Labor.newCraft("Silvercrafting",			AND(silver, timber),		I(jewelry),		P_.ARTISTRY,						SMITHY,		1000);
	public static final Job JEWELER = new Job("Silversmith", MakeJewel);
	
	public final static Labor Quarry = Labor.newReapR("Quarry Stone",				N(),						I(stone),		P_.STRENGTH,	Shire.STONES,		BUILDER,	500);
	public final static Labor MineIron = Labor.newReapR("Iron Mining",				N(),						I(iron),		P_.STRENGTH,	Shire.IORE,			null,			-1);
	public final static Labor MineSilver = Labor.newReapR("Silver Mining",			N(),						I(silver),		P_.STRENGTH,	Shire.SORE,			JEWELER,	1000);
	...
	public final static Labor Settle = Labor.newReapR("Settle Land",				N(),						I(land),		null,			Shire.WILDERNESS,	LUMBERJACK, 100);
