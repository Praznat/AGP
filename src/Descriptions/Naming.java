...
public class Naming implements Defs {
	...
	public static String randGoblinFirstName(byte fn, byte ln, boolean gender) {
		int numFN = 63; int numLN = 59;
...
//			case HERDING : return "Herding";
	...
	public static String QstackDes(Clan doer, int i) {
		...
		case WORK: out += "Do work: " + doer.QB.getChosenAct().getDesc(); break;
